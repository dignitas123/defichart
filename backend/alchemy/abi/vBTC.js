/**
 * works specifically for the data from a from to openPosition transaction on vBTC
 * TODO: has to be tested with closePosition and other types of functions
 */
export const openPositionABI = {
  inputs: [
    {
      components: [
...
/**
 * The full vBTC Contract ABI
 *
 * https://optimistic.etherscan.io/address/0x6c747d7ea6e4630b02ad26f98f6572b6885ad675#code
 * IMPORTANT: this is behind a proxy pattern of the vBTC contract
 */
export const vBTC_ABI_Object = [
  {
    anonymous: false,
    inputs: [
      {
